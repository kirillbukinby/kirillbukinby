...
public class OrdersHistoryPageTests extends BaseDriver {
    ...
    public void shouldDisplayOrdersTable() {
        // Assert
        assertElementDisplayed(ordersHistoryElements.getOrdersTable(), ERROR_ORDERS_TABLE_NOT_DISPLAYED);
    }
    ...
    public void shouldHaveCorrectTableStructure() {
        String headers = String.valueOf(ordersHistoryElements.getTableHeaderTexts());
        // Assert
        assertAll(
    ...
    public void shouldHavePagination() {
        // Assert
        assertElementDisplayed(ordersHistoryElements.getPagination(), ERROR_PAGINATION_NOT_DISPLAYED);
    }
