...
public class CartPageConstants {
    ...
    public static final String ERROR_INITIAL_QUANTITY_INCORRECT = "Начальное количество товара должно быть 1";
    public static final String ERROR_INITIAL_SUBTOTAL_INCORRECT = "Начальная стоимость товара не соответствует ожидаемой";
    public static final String ERROR_INITIAL_CART_SUBTOTAL_INCORRECT = "Начальная итоговая сумма не соответствует ожидаемой";
}