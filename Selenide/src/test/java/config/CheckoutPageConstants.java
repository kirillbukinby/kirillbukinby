...
public class CheckoutPageConstants {
    ...
    public static final String ERROR_INCORRECT_FIRST_NAME = "Имя заполнено некорректно";
    public static final String ERROR_INCORRECT_LAST_NAME = "Фамилия заполнена некорректно";
    public static final String ERROR_INCORRECT_PHONE = "Телефон заполнен некорректно";
    public static final String ERROR_INCORRECT_ADDRESS = "Адрес заполнен некорректно";
    public static final String ERROR_INCORRECT_CITY = "Город заполнен некорректно";
    public static final String ERROR_INCORRECT_STATE = "Область заполнена некорректно";
    public static final String ERROR_INCORRECT_POSTCODE = "Почтовый индекс заполнен некорректно";
    public static final String ERROR_INCORRECT_EMAIL = "Email заполнен некорректно";
}