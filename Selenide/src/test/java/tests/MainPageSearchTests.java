...
public class MainPageSearchTests extends BaseDriver {
    ...
    public void shouldSearchForProducts() {
        ...
        assertAll(
                ...
                () -> assertResultsNotEmpty(searchElements.getSearchResultsCount(), ERROR_NO_SEARCH_RESULTS)
        );
    }
    ...
    public void shouldSearchForDifferentQueries(String query, String expectedTitle) {
        ...
        assertAll(
                ...
                () -> assertResultsNotEmpty(searchElements.getSearchResultsCount(), String.format(ERROR_NO_RESULTS_FOR_QUERY, query))
        );
    }
    ...
    public void shouldSearchTitleContainExpectedText(String query, String expectedTitlePart) {
        ...
        // Assert
        assertAll(
                () -> assertTextContains(expectedTitlePart, searchElements.getSearchResultsTitle(), ERROR_SEARCH_TITLE_DOES_NOT_CONTAIN),
                () -> assertResultsNotEmpty(searchElements.getSearchResultsCount(), String.format(ERROR_NO_RESULTS_FOR_QUERY, query))
        );
    }
}
