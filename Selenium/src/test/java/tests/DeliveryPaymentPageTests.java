...
public class DeliveryPaymentPageTests extends BaseDriver {
    ...
    public void setUpTest() {
        deliveryPaymentPage.open();
        deliveryPaymentElements = deliveryPaymentPage.getDeliveryPaymentElements();
    }
    ...
    public void shouldDisplayContentTitle() {
        ...
        assertAll(
                ...
                () -> assertElementDisplayed(deliveryPaymentElements.isContentTitleDisplayed(), ERROR_CONTENT_TITLE_DISPLAYED),
                () -> assertElementDisplayed(deliveryPaymentElements.isPageTitleDisplayed(), ERROR_PAGE_TITLE_DISPLAYED)
        );
    }
    ...
    public void shouldDisplayIframe() {
        // Assert
        assertAll(
                () -> assertElementDisplayed(deliveryPaymentElements.isIframeDisplayed(), ERROR_IFRAME_DISPLAYED),
    ...
    public void shouldHaveNavigationMenu() {
        // Assert
        assertAll(
                () -> assertElementDisplayed(deliveryPaymentElements.isPageTitleDisplayed(), ERROR_PAGE_LOAD_TITLE),
                () -> assertElementDisplayed(deliveryPaymentElements.isIframeDisplayed(), ERROR_PAGE_LOAD_IFRAME)
        );
    }
}