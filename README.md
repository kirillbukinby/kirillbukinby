...
Опыт в IT — 1 год. Прошел курс от Skillbox «Профессия Инженер по автоматизации тестирования», где освоил основы автоматизации тестирования на Java. Имею практический опыт написания автотестов с использованием Selenium WebDriver, Selenide, JUnit, TestNG. Работал с GitLab CI/CD для настройки процессов непрерывной интеграции. Готов развиваться в направлении автоматизации тестирования и применять свои знания в реальных проектах.
...
**Стек:** Java, Selenium WebDriver, Selenide, JUnit, TestNG, GitLab CI/CD, Allure Reports, PostgreSQL, MySQL
...
[С проектом можно ознакомиться по ссылке](https://github.com/kirillbukinby/kirillbukinby/tree/main/Selenide)
...
- Настроил CI/CD пайплайн, что сократило время проверки кода на 70%
